  ...
  return (
    <div style={{ padding: 24 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: 16, marginBottom: 24 }}>
        ...
        <StatCard label="Open" value={trades.filter(t => t.status === 'open').length} color="#22c55e" />
        <StatCard label="Closed" value={trades.filter(t => t.status === 'closed').length} color="#6b7280" />
        <StatCard 
          label="Total P/L" 
