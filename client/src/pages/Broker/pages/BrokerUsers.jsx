    ...
    try {
      const res = await fetch(`${API_URL}/api/admin/users/${selectedUser._id}/wallet`, {
        ...
        body: JSON.stringify({
          ...
          currency: cur,
          reason: `${type === 'add' ? 'Added' : 'Deducted'} ${cur} by Broker`,
          ...
          <div style={{
            ...
            <div style={{ padding: '20px', borderBottom: '1px solid #333', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                <div style={{ width: 45, height: 45, borderRadius: '50%', background: '#10b981', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff', fontWeight: 700, fontSize: 18 }}>
            ...
            <div style={{ padding: '20px' }}>
              ...
              <div style={{ background: 'linear-gradient(135deg, #1a3a2a, #1a2a1a)', borderRadius: 12, padding: 16, marginBottom: 15, border: '1px solid #2a4a3a' }}>
                ...
                {walletAdjust.show && (
                  <div style={{ marginTop: 12, padding: 12, background: '#1a1a2e', borderRadius: 8 }}>
                    ...
                    <p style={{ margin: '8px 0 0 0', color: '#888', fontSize: 11 }}>Your broker wallet: ${adminWalletBalance.toFixed(2)} USD (adds deduct this much USD equivalent).</p>
                  </div>
                )}
              </div>
              ...
              <div style={{ background: '#252540', borderRadius: 10, padding: 12, marginBottom: 15 }}>
                ...
                <p style={{ margin: '4px 0 0 0', color: '#fff', fontSize: 14, fontWeight: 500 }}>
                  {adminAuth?.user?.name} (You)
                </p>
                <p style={{ margin: '2px 0 0 0', color: '#888', fontSize: 11 }}>
                  {adminAuth?.user?.oderId} • Broker
                </p>
              </div>
